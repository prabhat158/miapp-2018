...
public class GoingEventsAdapter extends RecyclerView.Adapter<GoingEventsAdapter.myViewHolder> {
    DatabaseHelper db;
...
//        holder.venue.setText("Venue: "+events.get(position).getVenue());
    ...
    public void removeItem(int position) {
        ...
        notif.cancelNotification(context,events.get(position).getId());
    ...
    public void openFragment(Fragment fragment, String tag){
        ...
        ft.replace(R.id.going_tabs_fragment, fragment, fragment.getTag());
